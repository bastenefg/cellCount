...
class SegmentationDialog(QDialog):
    ...
    def _build(self, from_results):
        ...
        header.addWidget(note("FIELD PREVIEW · LIVE / DEAD", "badge"))
        layout.addLayout(header)
        layout.addWidget(note("Review the image and object boundaries while adjusting detection settings. Preview counts cover this field; EBFP is evaluated only in a full run.", "muted"))
        top = QHBoxLayout()
